  ...
  return (
    <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg border border-gray-200 dark:border-gray-700 p-8 transition-colors duration-300">
      <div className="text-center mb-6">
        ...
        <p className="text-gray-600 dark:text-gray-400">Sign in to accelerate your career growth</p>
      </div>
      ...
      <div className="space-y-4 mb-6">
        <Button
          variant="outline"
          className="w-full gap-2 border-gray-200 dark:border-gray-600 bg-white dark:bg-gray-700 text-gray-900 dark:text-gray-100 hover:bg-gray-50 dark:hover:bg-gray-600"
        ...
        {!isLogin && (
          <div>
            ...
            <Input
              ...
              required={!isLogin}
              className="mt-1 bg-white dark:bg-gray-700 border-gray-200 dark:border-gray-600 text-gray-900 dark:text-gray-100 placeholder:text-gray-400 dark:placeholder:text-gray-500"
            />
          </div>
        )}
        <div>
